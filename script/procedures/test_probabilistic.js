...
let test_procedure_1_listen_prob = {
...
let test_procedure_2_listen_prob = {
    ...test_trial_listen_procedure_base,
    timeline_variables: [
        {
...
let test_procedure_3_listen_prob = {
    ...test_trial_listen_procedure_base,
    timeline_variables: [
        {
...
let test_procedure_4_listen_prob = {
    ...test_trial_listen_procedure_base,
    timeline_variables: [
        {
...
let test_procedure_5_listen_prob = {
    ...test_trial_listen_procedure_base,
    timeline_variables: [
        {
            'audio': 'wav/chicken_ka_norl3.wav',
...
let test_procedure_6_listen_prob = {
    ...test_trial_listen_procedure_base,
    timeline_variables: [
        {
...
let test_procedure_7_listen_prob = {
    ...test_trial_listen_procedure_base,
    timeline_variables: [
        {
            'audio': 'wav/sheep_ka_norl3.wav',
...
let test_procedure_8_listen_prob = {
    ...test_trial_listen_procedure_base,
    timeline_variables: [
...
let test_procedure_9_listen_prob = {
    ...test_trial_listen_procedure_base,
    timeline_variables: [
        {
            'audio': 'wav/cow_ka_norl3.wav',
...
let test_procedure_10_listen_prob = {
    ...test_trial_listen_procedure_base,
    timeline_variables: [
        {
            'audio': 'wav/duck_ka_norl3.wav',
...
let test_procedure_11_listen_prob = {
    ...test_trial_listen_procedure_base,
    timeline_variables: [
        {
            'audio': 'wav/horse_ka_norl3.wav',
...
let test_procedure_12_listen_prob = {
    ...test_trial_listen_procedure_base,
    timeline_variables: [
        {
            'audio': 'wav/pig_po_norl3.wav',
